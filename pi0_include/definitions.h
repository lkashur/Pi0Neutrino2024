...
#define DEFINECAT() \
    ...
    VARDLP_TCAT(kCategoryTTP_FVConTop1muNphCut,vars::category,cuts::fiducial_containment_topological_1muNph_cut); \
    VARDLP_TCAT(kCategoryTTP_All1muNphCut,vars::category,cuts::all_1muNph_cut); \
    ...
    VARDLP_RCAT(kCategoryPTT_FVConTop1muNphCut,vars::category,cuts::fiducial_containment_topological_1muNph_cut); \
    VARDLP_RCAT(kCategoryPTT_All1muNphCut,vars::category,cuts::all_1muNph_cut); \
    VARDLP_RCAT(kCategoryTopologyPTT_NoCut,vars::category_topology,cuts::no_cut); \
    VARDLP_RCAT(kCategoryTopologyPTT_All1muNphCut,vars::category_topology,cuts::all_1muNph_cut); \
    VARDLP_RCAT(kCategoryTopologyPTT_All1muNphCryoECut,vars::category_topology,cuts::all_1muNph_cryoE_cut); \
    VARDLP_RCAT(kCategoryTopologyPTT_All1muNphCryoWCut,vars::category_topology,cuts::all_1muNph_cryoW_cut);
...
#define TCATVAR(NAME,VAR)                                                                                       \
    ...
    VARDLP_TCAT(NAME ## _FVConTop1muNphCut,vars::VAR,cuts::fiducial_containment_topological_1muNph_cut); \
    VARDLP_TCAT(NAME ## _All1muNphCut,vars::VAR,cuts::all_1muNph_cut); \ 
    VARDLP_TCAT(NAME ## _All1muNphCryoECut,vars::VAR,cuts::all_1muNph_cryoE_cut); \
    VARDLP_TCAT(NAME ## _All1muNphCryoWCut,vars::VAR,cuts::all_1muNph_cryoW_cut);
...
#define RCATVAR(NAME,VAR)                                                                                          \
    ...
    VARDLP_PTT(NAME ## _FVConTop1muNphCut,vars::VAR,cuts::no_cut,cuts::fiducial_containment_topological_1muNph_cut); \
    VARDLP_PTT(NAME ## _All1muNphCut,vars::VAR,cuts::no_cut,cuts::all_1muNph_cut); \
    VARDLP_PTT(NAME ## _All1muNphCryoECut,vars::VAR,cuts::no_cut,cuts::all_1muNph_cryoE_cut); \
    VARDLP_PTT(NAME ## _All1muNphCryoWCut,vars::VAR,cuts::no_cut,cuts::all_1muNph_cryoW_cut);
